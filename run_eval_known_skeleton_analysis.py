...
if __name__ == '__main__':
    ...
    DATA_PATH = "/media/hjp/FAAC278CAC27430D/HJP/KUAICV/Hand/AbsoluteTrack/sample_data/recording_00.mp4"
    
    per_frame_mean_error = _track_sequence(DATA_PATH, model_path, override=True)
    print(per_frame_mean_error)
